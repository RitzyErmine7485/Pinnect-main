      ...
      <div className='flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
        <div className='bg-secondaryColor p-3 flex flex-0.7 w-full'>
          <div className='flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420'>
            {loading && <Spinner />}
            {wrongImageType && <p className='text-red-500 text-bold'>Wrong image type</p>}
            {!imageAsset ? (
              <label>
                <div className='flex flex-col justify-center items-center h-full'>
                  ...
                  <p className='mt-32 text-gray-400'>
                    Tip: Use high-quality JPG, SVG, PNG or GIF less than 20 MB
                  </p>
                </div>
                <input
                  type='file'
        ...
        <div className='flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full'>
          ...
          />
          {user && (
            <div className='flex gap-2 items-center bg-white rounde-lg'>
          ...
          <div className='flex flex-col'>
            <div>
              <p className='mb-2 fonr-semibold text-lg sm:text-xl'>Choose Pin Category</p>
              <select 
                name=''
                id=''
